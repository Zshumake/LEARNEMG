    ...
    return `
                ...
                <div class="nerve-selector" id="nerve-selector" style="margin-bottom: 30px;">
                    ...
                    <div class="nerve-buttons" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px;">
                        ...
                        <div class="nerve-group" style="background: #f0f9ff; border-radius: 12px; padding: 20px; border: 2px solid #0ea5e9;">
                            ...
                            <button class="nerve-btn" onclick="selectNerve('obturator')" style="display: block; width: 100%; margin-bottom: 10px; padding: 8px 15px; background: white; border: 2px solid #0ea5e9; border-radius: 8px; color: #0c4a6e; font-weight: 600; cursor: pointer; transition: all 0.2s;">🔀 Obturator Nerve</button>
                            <button class="nerve-btn" onclick="selectNerve('sural')" style="display: block; width: 100%; margin-bottom: 0; padding: 8px 15px; background: white; border: 2px solid #0ea5e9; border-radius: 8px; color: #0c4a6e; font-weight: 600; cursor: pointer; transition: all 0.2s;">👣 Sural Nerve</button>
                        </div>
                    </div>
                </div>
        ...
        <script>
            ...
            window.pathwayExplorer = {};
                ...
                window.pathwayExplorer.nerveData = {
                    ...
                    peroneal: {
                        ...
                        roots: "L4-S2",
                        imagePath: "Nerve Paths/Superficial Fibular Nerve.png",
            ...
            window.selectNerve = function(nerveName) {
                ...
                if (explorer.currentNerve.imagePath) {
                    imageContent = \`
                        <div style="text-align: center;">
                            ...
                            <img src="\${explorer.currentNerve.imagePath}" style="max-width: 100%; max-height: 400px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); border: 1px solid #e2e8f0;" alt="\${explorer.currentNerve.name} Pathway">
                ...
                document.getElementById('nerve-pathway-image').innerHTML = imageContent;

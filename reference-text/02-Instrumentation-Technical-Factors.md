...
## 2.1 Basic Electronic Circuitry [BOARD]
...
## 2.3 Stimulation Parameters [BOARD]
...
## 2.4 The Differential Amplifier [BOARD]
...
## 2.8 Electrical Safety in the EDX Laboratory [BOARD]
...
**Needle EMG in patients with pacemakers/ICDs [BOARD]:**
...
**Nerve conduction studies in patients with pacemakers/ICDs [BOARD]:**
...
**Repetitive nerve stimulation (RNS) in patients with pacemakers/ICDs [BOARD]:**
...
## 2.9 Artifact Recognition and Troubleshooting [BOARD]
...
## 2.10 AANEM Standards and Documentation Requirements [BOARD]
...
<!-- VERIFICATION: 2026-03-23 | Claims checked: 38 | Corrections: 0 | Unverified: 0 -->

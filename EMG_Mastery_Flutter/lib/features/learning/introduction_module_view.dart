...
class IntroductionModuleView extends StatelessWidget {
      ...
      child: ScrollableModuleScaffold(
        ...
        body: TabBarView(
          children: [
            ...
            KeepAliveTabWrapper(
              keepAlive: true,
              child: _buildTerminologyTab(content),
            ),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          const DiagramCard(
            imagePath: 'assets/images/pathology/peripheral_anatomy.webp',
          ...
          if (content.temporalEvolution != null)
            ...content.temporalEvolution!.map((tp) => _buildTemporalCard(tp)),
          const SizedBox(height: 32),
          const Text(
            'Check Your Understanding',
            style: TextStyle(
      ...
      child: Column(
        ...
        children: [
          ...
          if (content.localizationScenarios != null) ...[
            ...
            const SizedBox(height: 16),
            ...content.localizationScenarios!.map((s) => _buildScenarioCard(s)),
          ],
          const SizedBox(height: 32),
          const Text(
            'Check Your Understanding',
  ...
  Widget _buildQuizTab() {
    const questions = <QuizQuestion>[
      ...
      QuizQuestion(
        question:
            "A resident begins an EDX study by following a pre-set template without examining the patient first. What is the primary risk?",
        options: [
          "The study will take too long",
          "Missing the actual pathology by testing irrelevant nerves",
          "The patient will be in more pain",
          "The insurance will not cover the study",
        ],
        correctIndex: 1,
        explanation:
            "The Golden Rule of EDX is to LOCALIZE. Without a focused clinical question from the history and exam, you may test nerves that have nothing to do with the patient's problem, missing the real diagnosis entirely.",
      ),
      QuizQuestion(
        question:
            "A patient's median motor distal latency is 4.3 ms (upper limit of normal: 4.2 ms) but they have zero hand symptoms. What is the most appropriate interpretation?",
        options: [
          "Diagnose mild carpal tunnel syndrome",
          "Recommend surgery based on the numbers",
          "Consider this a normal variant and do NOT diagnose CTS",
          "Repeat the study in 6 months",
        ],
        correctIndex: 2,
        explanation:
            "Specificity is King. A borderline finding that does not correlate with the patient's symptoms is most likely a normal variant. Labeling a healthy person with CTS based on a 0.1 ms difference could lead to unnecessary surgery.",
      ),
      QuizQuestion(
        question:
            "Before turning on the EMG machine, what three steps should the physician always complete?",
        options: [
          "Calibrate the machine, test the stimulator, check the filters",
          "Review the MRI, order labs, consult neurology",
          "Take a clinical history, perform a physical exam, formulate a differential diagnosis",
          "Warm the limb, check impedance, set the gain",
        ],
        correctIndex: 2,
        explanation:
            "The Patient Encounter workflow is: (1) Clinical History, (2) Physical Exam, and (3) Differential Diagnosis. The machine comes AFTER you know what questions to ask the nervous system.",
      ),
      // Basics (3)
      QuizQuestion(
        question:
            "A patient has a confirmed C7 radiculopathy on MRI. The median SNAP recorded from the index finger is completely normal. Why?",
        options: [
          "The MRI is wrong",
          "The SNAP test was performed incorrectly",
          "The dorsal root ganglion (DRG) is proximal to the lesion, so peripheral sensory axons survive",
          "Sensory nerves are not affected by radiculopathy",
        ],
        correctIndex: 2,
        explanation:
            "The DRG sits outside the spinal canal. In radiculopathy, the compression is proximal (behind) the DRG. Since the sensory cell body in the DRG is still connected to its peripheral axon, the SNAP remains normal.",
      ),
      QuizQuestion(
        question:
            "In Amyotrophic Lateral Sclerosis (ALS), which component of the motor unit is primarily affected?",
        options: [
          "The myelin sheath (insulation)",
          "The neuromuscular junction (handshake)",
          "The anterior horn cell (motor neuron cell body)",
          "The muscle fiber itself",
        ],
        correctIndex: 2,
        explanation:
            "ALS is a motor neuron disease -- it destroys the cell body in the anterior horn of the spinal cord. This leads to widespread denervation with fasciculations and fibrillations on EMG with normal sensory studies.",
      ),
      QuizQuestion(
        question:
            "A nerve injury causes the myelin to be stripped but the axon remains intact. What is the expected recovery timeline?",
        options: [
          "No recovery is possible",
          "Weeks (remyelination)",
          "6-12 months (axon regrowth)",
          "Years (surgical repair required)",
        ],
        correctIndex: 1,
        explanation:
            "Demyelination recovers in weeks because the body can re-wrap myelin relatively quickly. The axon itself is intact, so no regrowth is needed.",
      ),
      // Technical (3)
      QuizQuestion(
        question:
            "You record a median motor distal latency of 5.2 ms. The patient's hand skin temperature is 28 degrees C. What should you do?",
        options: [
          "Report the finding as carpal tunnel syndrome",
          "Add a correction factor of 0.2 ms per degree",
          "Warm the hand to at least 32 degrees C and repeat the study",
          "The temperature does not affect distal latency",
        ],
        correctIndex: 2,
        explanation:
            "Cold temperature slows sodium channel kinetics, artificially prolonging latencies. The hand must be warmed to at least 32 degrees C before results can be trusted.",
      ),
      QuizQuestion(
        question:
            "You see a thick, rhythmic 'fuzzy' baseline obscuring all your waveforms. What is the most likely cause?",
        options: [
          "The nerve is severely damaged",
          "60 Hz electrical interference from building wiring",
          "The stimulator is malfunctioning",
          "The patient is moving too much",
        ],
        correctIndex: 1,
        explanation:
            "60 Hz interference is the most common artifact in the EMG lab. Fix it by scrubbing the skin to reduce impedance and ensuring good ground electrode contact.",
      ),
      QuizQuestion(
        question:
            "A patient with an ICD needs an EMG study. What is the primary safety concern?",
        options: [
          "Nerve conduction shocks will trigger the ICD",
          "The EMG machine will interfere with the pacemaker function",
          "Needle EMG electrical activity near the device may be sensed as a cardiac arrhythmia by the ICD",
          "EMG is absolutely contraindicated in all patients with cardiac devices",
        ],
        correctIndex: 2,
        explanation:
            "The primary concern with ICDs is that electrical activity from needle EMG near the generator may be misinterpreted by the device as ventricular fibrillation, potentially triggering an inappropriate shock.",
      ),
      // Localization (3)
      QuizQuestion(
        question:
            "A patient presents with hand weakness. The ulnar SNAP is absent. Where can the lesion NOT be located?",
        options: [
        ...
        correctIndex: 2,
        explanation:
            "In radiculopathy, the lesion is proximal to the DRG (preganglionic). The sensory cell bodies remain connected to their peripheral axons, so the SNAP is PRESERVED. An absent SNAP means the lesion is postganglionic.",
      ),
      QuizQuestion(
        question:
            "On repetitive nerve stimulation at 3 Hz, the CMAP amplitude drops by 20% by the 4th stimulus. What does this suggest?",
        options: [
        ...
        correctIndex: 2,
        explanation:
            "A decremental response (>10% amplitude drop) on low-frequency repetitive nerve stimulation is the hallmark of a postsynaptic NMJ disorder such as myasthenia gravis.",
      ),
      QuizQuestion(
        question:
            "EMG shows widespread fibrillations and fasciculations across 3 body regions. All SNAPs are normal. What is the most likely category?",
        options: [
        ...
        correctIndex: 2,
        explanation:
            "Widespread denervation across multiple body regions with completely normal sensory studies and fasciculations is the classic electrodiagnostic pattern for motor neuron disease.",
      ),
      // Glossary (3)
      QuizQuestion(
        question: "What does a 'positive sharp wave' on needle EMG indicate?",
        options: [
          "Normal muscle activity during contraction",
          "A healthy motor unit firing voluntarily",
          "Active denervation -- a muscle fiber spontaneously firing after losing its nerve supply",
          "An artifact from the needle touching bone",
        ],
        correctIndex: 2,
        explanation:
            "Positive sharp waves are the electrical signatures of denervation. When a muscle fiber loses its nerve connection, it becomes electrically unstable and fires spontaneously.",
      ),
      QuizQuestion(
        question:
            "Why is supramaximal stimulation necessary for valid nerve conduction studies?",
        options: [
          "It makes the study faster",
          "It ensures ALL nerve fibers are activated, giving a true measurement of the nerve's health",
          "It reduces artifact",
          "It is only needed for sensory studies",
        ],
        correctIndex: 1,
        explanation:
            "If you stimulate submaximally, you only activate a portion of the fibers, making the CMAP amplitude artificially low. This could lead to a false diagnosis of axonal loss.",
      ),
      QuizQuestion(
        question:
            "A motor unit potential has 6 phases and increased duration. What process does this most likely represent?",
        options: [
          "Acute denervation",
          "Myopathic changes",
          "Chronic reinnervation via collateral sprouting",
          "Normal variation in young adults",
        ],
        correctIndex: 2,
        explanation:
            "Polyphasic, long-duration, high-amplitude MUAPs are the hallmark of chronic neurogenic reinnervation. Surviving neurons send collateral sprouts to adopt orphaned muscle fibers.",
      ),
    ];

    return const QuizSessionView(questions: questions);
  }
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Center(
            child: Image.asset(
              'assets/images/hardware/headbox.webp',
              height: 200,
              fit: BoxFit.contain,
            ),
          ),

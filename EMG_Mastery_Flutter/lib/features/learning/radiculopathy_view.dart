    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          const DiagramCard(
            imagePath:
                'assets/images/pathology/radiculopathy_pathophysiology.webp',
    ...
    return Container(
      ...
      child: const Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.search_rounded, color: Color(0xFFC2410C), size: 32),
              SizedBox(width: 12),
              Text(
      ...
      child: const Column(
        ...
        children: [
          ...
          _ScenarioTile(
            number: 2,
            preview:
                '55-year-old runner with back pain radiating to the dorsal foot...',
            stem:

...
class IntroductionData {
  ...
  static final List<SunderlandGrade> sunderlandClassification = [
    SunderlandGrade(
      ...
      recovery:
          'Complete recovery in days to 12 weeks. No Wallerian degeneration occurs.',
      edxFindings:
          'Conduction block at the lesion site. Normal distal responses. No fibrillations on EMG.',
    ),
    SunderlandGrade(
      grade: 'II (Axonotmesis)',
      injury: 'Axon severed, endoneurium intact',
      pathology:
          'Wallerian degeneration occurs distal to the injury. The endoneurial tube remains intact as a guide for regrowth.',
      recovery:
          'Good prognosis. Axon regrows at ~1 mm/day along the intact tube. Full recovery expected.',
      edxFindings:
          'Reduced CMAP/SNAP amplitudes distally (after Wallerian degeneration). Fibrillations appear at 2-5 weeks.',
    ),
    SunderlandGrade(
      grade: 'III-V (Neurotmesis)',
      injury: 'Progressive connective tissue disruption',
      pathology:
          'Grade III: endoneurium disrupted. Grade IV: perineurium disrupted. Grade V: complete nerve transection (epineurium disrupted).',
      recovery:
          'Poor without surgical intervention. Misdirected regrowth leads to incomplete recovery. Surgery may be needed for Grades IV-V.',
      edxFindings:
          'Absent distal responses. Dense fibrillations. No voluntary MUAPs in affected muscles. No improvement over months without surgery.',
    ),
  ];
  ...
  static final List<TemporalTimepoint> temporalEvolution = [
    TemporalTimepoint(
      timepoint: 'Day 0-2',
      finding: 'NCS may appear NORMAL',
      explanation:
          'Wallerian degeneration has not yet occurred. The distal nerve segment is still alive and conducting normally, even though it has been severed from its cell body.',
    ),
    TemporalTimepoint(
      timepoint: 'Day 3-5',
      finding: 'Motor amplitudes begin to drop',
      explanation:
          'The distal motor axons begin to degenerate. CMAP amplitudes recorded distal to the injury site progressively decrease. This is the earliest NCS change.',
    ),
    TemporalTimepoint(
      timepoint: 'Day 7-11',
      finding: 'Sensory amplitudes drop',
      explanation:
          'Sensory axons undergo Wallerian degeneration slightly later than motor axons. SNAP amplitudes decrease. By day 10-11, the process is largely complete.',
    ),
    TemporalTimepoint(
      timepoint: 'Week 2-3',
      finding: 'Fibrillations appear PROXIMALLY',
      explanation:
          'Denervated muscle fibers closest to the injury site develop membrane instability first. Fibrillations and positive sharp waves appear on needle EMG in proximal muscles.',
    ),
    TemporalTimepoint(
      timepoint: 'Week 3-5',
      finding: 'Fibrillations appear DISTALLY',
      explanation:
          'More distal muscles develop fibrillations later because the degenerating axon terminals persist longer in more distal locations. This is why timing matters for EDX.',
    ),
    TemporalTimepoint(
      timepoint: 'Months',
      finding: 'Reinnervation potentials appear',
      explanation:
          'If recovery is occurring, nascent (small, polyphasic) MUAPs appear first, gradually increasing in size as collateral sprouts mature. Large, polyphasic MUAPs indicate established chronic reinnervation.',
    ),
  ];
  ...
  static final MartinGruberContent martinGruber = MartinGruberContent(
    ...
    prevalence:
        'Present in 15-30% of the population (bilateral in approximately 60% of individuals who have MGA)',
    description:
        'A crossover of motor nerve fibers from the median nerve to the ulnar nerve in the forearm. Fibers leave the median nerve (typically from the AIN branch) and join the ulnar nerve, innervating ulnar hand muscles via the median nerve trunk.',
    clinicalImpact: [
    ...
    source:
        'Kimura, Electrodiagnosis in Diseases of Nerve and Muscle; prevalence data from Amoiridis & Vlachonikolis, 1992',
  );
  ...
  static final List<ExpandedPattern> expandedPatterns = [
    ExpandedPattern(
      ...
      snap:
          'May be ABSENT or REDUCED if the sensory fibers of that specific nerve are affected (e.g., absent median SNAP in CTS). Other nerves are normal.',
      cmap:
          'Prolonged DISTAL LATENCY at the entrapment site with normal proximal segments. Conduction block or focal slowing may be present across the compression point.',
      emg:
          'Denervation limited to muscles innervated by the affected nerve, distal to the lesion.',
      keyFeature: 'Focal abnormality confined to ONE nerve territory',
    ),
    ExpandedPattern(
      site: 'Polyneuropathy (Length-Dependent)',
      snap:
          'ABSENT distally (sural, superficial peroneal affected first), gradually worsening proximal. Follows a length-dependent gradient.',
      cmap:
          'REDUCED amplitudes distally (fibular, tibial affected more than median, ulnar). Velocities mildly slow in axonal; markedly slow in demyelinating.',
      emg:
          'Denervation most prominent distally (intrinsic foot muscles > legs > hands). Chronic neurogenic changes in a stocking-glove distribution.',
      keyFeature:
          'Symmetric, distal-to-proximal gradient affecting MULTIPLE nerves',
    ),
    ExpandedPattern(
      site: 'Motor Neuron Disease (e.g., ALS)',
      snap:
          'NORMAL -- sensory nerves are completely spared because the disease affects motor neurons only.',
      cmap:
          'May be REDUCED from motor neuron loss, but sensory amplitudes are preserved. The dissociation between reduced CMAPs and normal SNAPs is characteristic.',
      emg:
          'Widespread fibrillations and fasciculations across 3+ body regions (bulbar, cervical, thoracic, lumbosacral). Large, polyphasic MUAPs with reduced recruitment.',
      keyFeature: 'Widespread motor denervation with NORMAL sensory studies',
    ),
    ExpandedPattern(
      site: 'Myopathy',
      snap:
          'NORMAL -- peripheral nerves are not affected in primary muscle disease.',
      cmap:
          'Usually NORMAL (the nerve is fine; the muscle is sick). May be mildly reduced in severe cases.',
      emg:
          'Short-duration, low-amplitude, polyphasic MUAPs with EARLY recruitment. Fibrillations may be present in inflammatory myopathies (irritable myopathy). NO fasciculations.',
  ...
  static final List<LocalizationScenario> localizationScenarios = [
    LocalizationScenario(
      stem:
          'A 52-year-old presents with right hand weakness and numbness in the ring and small fingers. The ulnar SNAP is absent. The ulnar CMAP amplitude is reduced.',
      question:
          'Based on the absent ulnar SNAP, which localization can be definitively EXCLUDED?',
      options: [
      ...
      correct: 2,
      explanation:
          'An absent SNAP definitively excludes radiculopathy. In radiculopathy, the lesion is proximal to the DRG (preganglionic), so sensory axons in the periphery survive and the SNAP remains NORMAL. An absent SNAP means the lesion is postganglionic -- the problem is in the plexus, nerve trunk, or distally.',
    ),
    LocalizationScenario(
      stem:
          'A 68-year-old diabetic presents with right foot drop. NCS shows: absent fibular CMAP, normal sural SNAP, normal tibial motor study.',
      question: 'What is the most likely localization?',
      options: [
        'S1 radiculopathy',
        'Common fibular neuropathy at the fibular head',
        'L5 radiculopathy or fibular neuropathy (cannot distinguish with this data alone)',
        'Diabetic polyneuropathy',
      ],
      correct: 2,
      explanation:
          'This is a critical teaching point: the sural SNAP (which is a tibial/S1 territory nerve) is NORMAL in BOTH L5 radiculopathy and fibular neuropathy. To distinguish them, you need needle EMG of non-fibular L5 muscles (tibialis posterior, gluteus medius). If those are abnormal, it is radiculopathy. If only fibular-innervated muscles are affected, it is a fibular neuropathy.',
    ),
    LocalizationScenario(
      stem:
          'A 34-year-old motorcyclist after a high-speed crash has a flail right arm. NCS shows: absent median, ulnar, and radial SNAPs. All CMAPs are absent.',
      question: 'What is the localization?',
      options: [
        'Cervical spinal cord injury',
        'Pan-brachial plexopathy',
        'Multiple cervical radiculopathies (C5-T1)',
        'Peripheral polyneuropathy',
      ],
      correct: 1,
      explanation:
          'The ABSENT SNAPs are the key finding. In spinal cord injury or radiculopathy, SNAPs would be PRESERVED (preganglionic lesion). Absent SNAPs across all three major nerve territories prove the lesion is postganglionic -- at the brachial plexus level. This is pan-brachial plexopathy, a devastating injury requiring urgent surgical evaluation.',
    ),
    LocalizationScenario(
      stem:
          'A 45-year-old woman presents with fluctuating bilateral ptosis and difficulty swallowing that worsens throughout the day. Routine NCS (sensory and motor) is completely normal.',
      question: 'What additional electrodiagnostic test should be performed?',
      options: [
        'Needle EMG of all four extremities',
        'Repetitive nerve stimulation (RNS) at 3 Hz',
        'F-wave studies of all nerves',
        'Somatosensory evoked potentials',
      ],
      correct: 1,
      explanation:
          'The clinical presentation (fluctuating weakness, ptosis, bulbar symptoms, diurnal variation) is classic for myasthenia gravis -- a neuromuscular junction disorder. Routine NCS is normal in MG because the nerve and muscle are healthy. Repetitive nerve stimulation at 2-3 Hz will show a decremental response (>10% drop) as the impaired NMJ fails to maintain transmission with repeated stimulation.',
    ),
    LocalizationScenario(
      stem:
          'A 70-year-old man has progressive weakness over 12 months. EMG shows: fibrillations and fasciculations in the tongue, both arms, and both legs. All SNAPs are normal. CMAPs are reduced in multiple nerves.',

  ...
  tabs: [
    TopicTab(
      ...
      blocks: [
        ...
        NumberedListBlock([
          const MapEntry(
            "1",
            "Resting State (-70mV): The nerve is negatively charged. Actively maintained by the Na+/K+ ATPase pump, which burns ATP to push 3 Na+ out for every 2 K+ in. The nerve is a loaded spring.",
          ),
          const MapEntry(
            "2",
            "Threshold (-55mV): When stimulus pushes charge to -55mV, voltage-gated Na+ channels suddenly pop open. An explosive chain reaction begins.",
          ),
          const MapEntry(
            "3",
            "Depolarization (+30mV): Na+ floods into the cell, rapidly shifting internal charge from negative to positive. This is the all-or-none action potential spike we record on screen.",
          ),
          const MapEntry(
            "4",
            "Repolarization (Restoring): Na+ channels snap shut (inactivation), K+ channels open. K+ rushes out, dropping internal charge back toward negative.",
          ),
          const MapEntry(
            "5",
            "Hyperpolarization (Overshoot): K+ channels are slightly slow to close, allowing too much positive charge to escape. Potential briefly drops below -70mV before resting state restores.",
          ),
        ]),
    ...
    TopicTab(
      ...
      blocks: [
        ...
        NumberedListBlock([
          const MapEntry(
            "S1",
            "Normal Benchmark: Median Motor -- distance 250mm, proximal latency 8.5ms, distal latency 3.5ms. Step 1: Subtract latencies (8.5 - 3.5 = 5.0ms). Step 2: Divide (250 / 5.0 = 50 m/s). This is a perfectly normal conduction velocity.",
          ),
          const MapEntry(
            "S2",
            "Severe Pathology: Ulnar Motor -- distance 300mm, proximal latency 12.8ms, distal latency 2.8ms. Step 1: Subtract (12.8 - 2.8 = 10.0ms). Step 2: Divide (300 / 10.0 = 30 m/s). This velocity has crashed into the 30s -- a severe primary demyelinating neuropathy.",
          ),
        ]),
        PearlBlock(
          "Why Subtract?",
    ...
    TopicTab(
      ...
      blocks: [
        ...
        TextBlock(
          'Test your understanding of nerve conduction study principles.',
          isIntro: true,
        ),
        NumberedListBlock([
          const MapEntry(
            "Q1",
            "A technician performs NCS on a patient with icy cold hands from walking outside. What pattern does this mimic? -- Answer: A primary demyelinating neuropathy. Cold temperatures slow conduction velocity and prolong latencies, perfectly mirroring demyelination. It also paradoxically increases amplitude.",
          ),
          const MapEntry(
            "Q2",
            "You stimulate the ulnar nerve at the wrist, but note the initial deflection is a sharp positive (downward) dip. What is the cause? -- Answer: The G1 (Active) electrode is not placed over the true motor endpoint. It records the approaching wavefront as volume conduction before the muscle fully depolarizes under it.",
          ),
          const MapEntry(
            "Q3",
            "Which fibers are you evaluating during a standard Sural SNAP study? -- Answer: Large, myelinated A-beta fibers. Standard EDX machines only resolve the massive A-alpha and A-beta fibers. We are completely blind to small A-delta and C fibers.",
          ),
          const MapEntry(
            "Q4",
            "A patient presents 24 hours after a knife wound severed their median nerve at the elbow. What will the distal CMAP amplitude look like? -- Answer: Perfectly normal. Wallerian degeneration takes 3-5 days (motor) to complete. The distal axon remains electrically viable for several days.",
          ),
          const MapEntry(
            "Q5",
            "To declare Conduction Block, what must happen to the proximal CMAP compared to distal? -- Answer: Amplitude must drop >50% with minimal temporal dispersion. A sudden massive drop proves the signal hit a focal blockade of demyelination. If it spreads widely, that is dispersion, not block.",
          ),
          const MapEntry(
            "Q6",
            "Why do we subtract Distal Latency from Proximal Latency when calculating CV? -- Answer: To eliminate the time spent crossing the Neuromuscular Junction. The NMJ chemical transmission is slow. Subtracting latencies isolates pure nerve travel time so velocity isn't artificially slow.",
          ),
        ]),
      ],
    ),

    ...
    TopicTab(
      ...
      blocks: [
        ...
        NumberedListBlock([
          const MapEntry(
            "I",
            "Myelin damage only (= Neurapraxia). Complete recovery in days to weeks.",
          ),
          const MapEntry(
            "II",
            "Axon severed, Endoneurium intact (= Axonotmesis). Good-to-excellent recovery at 1mm/day over months.",
          ),
          const MapEntry(
            "III",
            "Endoneurium disrupted, Perineurium intact. Poor-to-fair recovery. Regenerating sprouts may enter wrong tubes causing aberrant reinnervation.",
          ),
          const MapEntry(
            "IV",
            "Perineurium disrupted, Epineurium intact. Very poor recovery. Neuroma-in-continuity forms, mechanically blocking regrowth.",
          ),
          const MapEntry(
            "V",
            "Complete nerve transection (= Neurotmesis). No spontaneous recovery. Requires surgical intervention.",
          ),
        ]),
        PearlBlock(
    ...
    TopicTab(
      ...
      blocks: [
        ...
        NumberedListBlock([
          const MapEntry(
            "Q1",
            "What is the primary pathological difference between demyelinating and axonal neuropathies? -- Answer: Demyelinating affects myelin (slowed velocity, conduction blocks); axonal affects the axon itself (reduced amplitudes, fibrillations on EMG).",
          ),
          const MapEntry(
            "Q2",
            "In a demyelinating neuropathy, what is the most characteristic NCS finding? -- Answer: Slowed conduction velocity with conduction blocks and temporal dispersion.",
          ),
          const MapEntry(
            "Q3",
            "What NCS finding indicates axonal loss rather than demyelination? -- Answer: Reduced CMAP amplitude with normal/near-normal conduction velocity.",
          ),
          const MapEntry(
            "Q4",
            "What are the three progressive stages of compression neuropathy? -- Answer: Ischemia (reversible) -> Demyelination (conduction block) -> Axonal Loss (Wallerian degeneration).",
          ),
          const MapEntry(
            "Q5",
            "What EMG finding would you expect in an acute axonal neuropathy (<2 weeks)? -- Answer: Reduced recruitment with NO spontaneous activity yet. Fibrillations take 2-3 weeks to appear.",
          ),
          const MapEntry(
            "Q6",
            "What pathophysiological mechanism causes conduction block? -- Answer: Severe focal demyelination prevents action potential propagation despite intact axons. Reversible with remyelination.",
          ),
          const MapEntry(
            "Q7",
            "A diabetic patient has reduced sural/superficial peroneal SNAPs but normal median/ulnar SNAPs. What pattern? -- Answer: Length-dependent sensory polyneuropathy (stocking-glove). Longest nerves affected first.",
          ),
          const MapEntry(
            "Q8",
            "What is the key difference between Seddon's and Sunderland's classification? -- Answer: Seddon uses 3 categories by severity; Sunderland uses 5 grades based on specific anatomical structures damaged.",
          ),
          const MapEntry(
            "Q9",
            "Peripheral nerves regenerate at approximately what rate? -- Answer: 1 millimeter per day (approximately 1 inch per month). Distance to target determines recovery timeline.",
          ),
        ]),
      ],
    ),

...
class ClinicalDecisionTrees {
  ...
  static const footDrop = TreeNode(
    ...
    noBranch: TreeNode(
      question:
          'Is there conduction block or slowing across the fibular head on NCS?',
  ...
  static const handWeakness = TreeNode(
    question:
        'Patient has hand intrinsic muscle weakness. Is the MEDIAN sensory SNAP abnormal?',
    ...
    yesBranch: TreeNode(
      ...
      noBranch: TreeNode(
        question:
            'Is weakness limited to LOAF muscles (lumbricals 1-2, opponens, APB, FPB)?',
    ...
    noBranch: TreeNode(
      ...
      noBranch: TreeNode(
        question:
            'Are there fibrillations in C8-T1 muscles from multiple peripheral nerves?',
  ...
  static const weaknessDifferential = TreeNode(
    question:
        'Patient presents with weakness. Are there UPPER motor neuron signs (hyperreflexia, Babinski, spasticity)?',
    yesLabel: 'UMN signs present',
    noLabel: 'No UMN signs',
    yesBranch: TreeNode(
      question:
          'Are there also LOWER motor neuron signs (atrophy, fasciculations, hyporeflexia)?',
    ...
    noBranch: TreeNode(
      question:
          'Is the weakness PROXIMAL (shoulders, hips) or DISTAL (hands, feet)?',
      yesLabel: 'Proximal',
      noLabel: 'Distal',
      yesBranch: TreeNode(
  ...
  static const axonalVsDemyelinating = TreeNode(
    question:
        'NCS shows abnormalities. Is there significant CONDUCTION VELOCITY slowing (motor CV <75% LLN)?',
    yesLabel: 'Significant CV slowing',
    noLabel: 'CV near normal or mildly slow',
    yesBranch: TreeNode(
      question:
          'Is the slowing UNIFORM across all nerves, or SEGMENTAL/MULTIFOCAL?',
    ...
    noBranch: TreeNode(
      ...
      yesBranch: TreeNode(
        question:
            'Is the pattern length-dependent (legs worse than arms, distal worse than proximal)?',

...
class BoardComparisons {
  ...
  static const neuropathicVsMyopathic = (
    ...
    rows: [
      ...
      ComparisonRow(feature: 'Phases', values: ['Polyphasic', 'Polyphasic']),
      ComparisonRow(
        feature: 'Recruitment',
        values: [
          'Reduced (fewer MUs, firing fast)',
          'Early (many MUs, low force)',
        ],
      ),
      ComparisonRow(
        feature: 'Fibs/PSWs',
  ...
  static const mgVsLemsVsBotulism = (
    ...
    rows: [
      ...
      ComparisonRow(feature: 'Resting CMAP', values: ['Normal', 'LOW', 'LOW']),
      ComparisonRow(
        feature: '3 Hz RNS',
  ...
  static const radiationVsTumor = (
    ...
    rows: [
      ...
      ComparisonRow(
        ...
        values: [
          'Myokymic discharges (50-70%)',
          'Fibs/PSWs only (myokymia in ~4%)',
        ],
      ),
      ComparisonRow(feature: 'Horner Syndrome', values: ['Rare', 'Common']),
      ComparisonRow(
        feature: 'Onset',
  ...
  static const umnVsLmn = (
    ...
    rows: [
      ...
      ComparisonRow(
        feature: 'Weakness Pattern',
        values: [
          'Pyramidal (extensors > flexors in UE)',
          'Follows myotome/peripheral nerve',
        ],
      ),
      ComparisonRow(
        feature: 'EMG Findings',
        values: [
          'Normal (EMG tests LMN only)',
          'Fibs/PSWs, large MUAPs, reduced recruitment',
        ],
      ),
      ComparisonRow(
        feature: 'NCS',
      ...
      ComparisonRow(
        feature: 'Examples',
        values: [
          'Stroke, MS, SCI above conus',
          'Radiculopathy, neuropathy, AHC disease',
        ],
      ),
    ],
    footnote:

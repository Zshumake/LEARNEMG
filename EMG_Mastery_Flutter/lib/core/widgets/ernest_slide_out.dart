      ...
      child: Stack(
        children: [
          ...
          AnimatedPositioned(
            ...
            child: Semantics(
              button: true,
              label: _open ? 'Close Ernest assistant' : 'Open Ernest assistant',
              child: GestureDetector(
                onTap: _toggle,
                behavior: HitTestBehavior.opaque,
                child: Padding(
                  // Transparent left padding widens the tap target to >=48px
                  // (a11y minimum) while keeping the visible tab slim.

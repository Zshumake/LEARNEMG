...
class _EarlPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawPath(
      Path()
        ..moveTo(_s(388, s), _s(150, s))
        ..quadraticBezierTo(_s(375, s), _s(160, s), _s(380, s), _s(175, s))
        ..quadraticBezierTo(_s(392, s), _s(165, s), _s(388, s), _s(150, s))
        ..close(),
      dirtDark,
    );
    canvas.drawPath(
      Path()
        ..moveTo(_s(385, s), _s(153, s))
        ..quadraticBezierTo(_s(378, s), _s(160, s), _s(382, s), _s(170, s))
        ..quadraticBezierTo(_s(388, s), _s(163, s), _s(385, s), _s(153, s))
        ..close(),
      dirtLight,
    );
    ...
    canvas.drawPath(
      Path()
        ..moveTo(_s(315, s), _s(470, s))
        ..quadraticBezierTo(_s(305, s), _s(480, s), _s(310, s), _s(500, s))
        ..quadraticBezierTo(_s(325, s), _s(490, s), _s(315, s), _s(470, s))
        ..close(),
      dirtDark,
    );
    canvas.drawPath(
      Path()
        ..moveTo(_s(313, s), _s(475, s))
        ..quadraticBezierTo(_s(308, s), _s(482, s), _s(311, s), _s(495, s))
        ..quadraticBezierTo(_s(320, s), _s(488, s), _s(313, s), _s(475, s))
        ..close(),
      dirtLight,
    );
    ...
    final impactBgPaint = Paint()
      ..color = const Color(0xFF777777).withValues(alpha: 0.4)
      ..strokeWidth = 1.5
      ..style = PaintingStyle.stroke;
    final impactFgPaint = Paint()
      ..color = outlineColor
      ..strokeWidth = 2.5
      ..style = PaintingStyle.stroke;
    ...
    void drawImpact(double x, double y) {
      ...
      final bg = Path()
        ..moveTo(_s(x + 1, s), _s(y + 1, s))
        ..lineTo(_s(x - 14, s), _s(y - 9, s))
        ..moveTo(_s(x + 1, s), _s(y + 1, s))
        ..lineTo(_s(x - 9, s), _s(y + 21, s))
        ..lineTo(_s(x - 4, s), _s(y + 36, s))
        ..moveTo(_s(x + 1, s), _s(y + 1, s))
        ..lineTo(_s(x + 21, s), _s(y + 11, s))
        ..lineTo(_s(x + 36, s), _s(y + 1, s));
      canvas.drawPath(bg, impactBgPaint);

      final fg = Path()
        ..moveTo(_s(x, s), _s(y, s))
        ..lineTo(_s(x - 15, s), _s(y - 10, s))
        ..moveTo(_s(x, s), _s(y, s))
        ..lineTo(_s(x - 10, s), _s(y + 20, s))
        ..lineTo(_s(x - 5, s), _s(y + 35, s))
        ..moveTo(_s(x, s), _s(y, s))
        ..lineTo(_s(x + 20, s), _s(y + 10, s))
        ..lineTo(_s(x + 35, s), _s(y, s));
    ...
    // LED highlight arc
    canvas.drawArc(
      Rect.fromCircle(center: Offset(_s(365, s), _s(155, s)), radius: _s(5, s)),
      -pi,
      pi,
      false,
      Paint()
    ...
    if (zapOpacity > 0.01) {
      final zapPaint = Paint()
        ..color = const Color(0xFF88DDED).withValues(alpha: zapOpacity)
        ..strokeWidth = _s(5, s)
        ..style = PaintingStyle.stroke
        ..strokeCap = StrokeCap.round;
      canvas.drawPath(
    ...
    _drawText(
      ...
      _s(152, s),
      _s(28, s),
      const Color(0xFF1A1C1A).withValues(alpha: 0.6),
      s,
    );
    ...
    // Left X
    canvas.drawLine(
      Offset(_s(205, s), _s(415, s)),
      Offset(_s(230, s), _s(445, s)),
      scarPaint,
    );
    canvas.drawLine(
      Offset(_s(230, s), _s(415, s)),
      Offset(_s(205, s), _s(445, s)),
      scarPaint,
    );
    // Right X
    canvas.drawLine(
      Offset(_s(270, s), _s(415, s)),
      Offset(_s(295, s), _s(445, s)),
      scarPaint,
    );
    canvas.drawLine(
      Offset(_s(295, s), _s(415, s)),
      Offset(_s(270, s), _s(445, s)),
      scarPaint,
    );
  ...
  void _drawEarlFace(Canvas canvas, double s, Paint outlinePaint) {
    ...
    final faceBackdropPaint = Paint()
      ..color = const Color(0xFF2C3330).withValues(alpha: 0.3);
    canvas.drawPath(
      Path()
    ...
    void drawTiredEye(
      ...
      canvas.drawCircle(
        Offset(_s(cx, s), _s(cy, s)),
        _s(18, s),
        Paint()..color = const Color(0xFFE8E4D3),
      );
      canvas.drawCircle(
        Offset(_s(cx, s), _s(cy, s)),
        _s(18, s),
      ...
      canvas.drawCircle(
        Offset(_s(pcx, s), _s(cy, s)),
        _s(6, s),
        Paint()..color = const Color(0xFF1A1C1A),
      );
      canvas.drawCircle(
        Offset(_s(cx, s), _s(cy, s)),
        _s(18, s),
        Paint()
          ..color = const Color(0xFF2C3330).withValues(alpha: 0.4)
          ..style = PaintingStyle.stroke
          ..strokeWidth = _s(4, s),
      );
      ...
      canvas.drawPath(
        Path()
          ..moveTo(_s(cx - 22, s), _s(lidYStart, s))
          ..quadraticBezierTo(
            _s(cx, s),
            _s(lidYCurve, s),
            _s(cx + 22, s),
      ...
      canvas.drawPath(
        ...
        Paint()
          ..color = const Color(0xFF2C3330).withValues(alpha: 0.8)
          ..strokeWidth = _s(3, s)
          ..style = PaintingStyle.stroke
          ..strokeCap = StrokeCap.round,
      );
    ...
    final leftClip = Path()
      ..moveTo(_s(185, s), _s(268, s))
      ..quadraticBezierTo(_s(210, s), _s(280, s), _s(235, s), _s(268, s))
      ..lineTo(_s(235, s), _s(310, s))
      ..lineTo(_s(185, s), _s(310, s))
      ..close();
    drawTiredEye(210, 275, 212, leftClip, 268, 280);

    final rightClip = Path()
      ..moveTo(_s(265, s), _s(268, s))
      ..quadraticBezierTo(_s(290, s), _s(280, s), _s(315, s), _s(268, s))
      ..lineTo(_s(315, s), _s(310, s))
      ..lineTo(_s(265, s), _s(310, s))
      ..close();
    ...
    canvas.drawPath(
      Path()
        ..moveTo(_s(180, s), _s(315, s))
        ..quadraticBezierTo(_s(175, s), _s(325, s), _s(190, s), _s(332, s)),
      dimplePaint,
    );
    canvas.drawPath(
      Path()
        ..moveTo(_s(320, s), _s(315, s))
        ..quadraticBezierTo(_s(325, s), _s(325, s), _s(310, s), _s(332, s)),
      dimplePaint,
    );
    // Mouth inner shadow
    canvas.drawPath(
      Path()
        ..moveTo(_s(230, s), _s(322, s))
        ..quadraticBezierTo(_s(250, s), _s(315, s), _s(270, s), _s(322, s)),
      Paint()
        ..color = const Color(0xFF2C3330).withValues(alpha: 0.5)
        ..strokeWidth = _s(4, s)
        ..style = PaintingStyle.stroke
        ..strokeCap = StrokeCap.round,
    );
  ...
  void _drawEarlProng(
    ...
    // Gloss line
    canvas.drawRect(
      Rect.fromLTWH(x + _s(2, s), y + _s(5, s), _s(4, s), _s(70, s)),
    ...
    if (isLeft) {
      canvas.drawPath(
        Path()
          ..moveTo(_s(182, s), _s(50, s))
          ..quadraticBezierTo(_s(186, s), _s(45, s), _s(194, s), _s(52, s))
          ..lineTo(_s(194, s), _s(62, s))
          ..quadraticBezierTo(_s(186, s), _s(65, s), _s(182, s), _s(58, s))
          ..close(),
        crackDark,
      );
      canvas.drawPath(
        Path()
          ..moveTo(_s(184, s), _s(52, s))
          ..quadraticBezierTo(_s(188, s), _s(48, s), _s(192, s), _s(53, s))
          ..lineTo(_s(192, s), _s(60, s))
          ..quadraticBezierTo(_s(188, s), _s(62, s), _s(184, s), _s(56, s))
          ..close(),
        crackLight,
      );
      canvas.drawPath(
        Path()
          ..moveTo(_s(182, s), _s(85, s))
          ..quadraticBezierTo(_s(188, s), _s(80, s), _s(194, s), _s(88, s))
          ..lineTo(_s(194, s), _s(95, s))
          ..lineTo(_s(182, s), _s(95, s))
          ..close(),
        crackDark,
      );
    } else {
      canvas.drawPath(
        Path()
          ..moveTo(_s(306, s), _s(70, s))
          ..quadraticBezierTo(_s(312, s), _s(65, s), _s(318, s), _s(75, s))
          ..lineTo(_s(318, s), _s(90, s))
          ..quadraticBezierTo(_s(310, s), _s(95, s), _s(306, s), _s(85, s))
          ..close(),
        crackDark,
      );
      canvas.drawPath(
        Path()
          ..moveTo(_s(308, s), _s(73, s))
          ..quadraticBezierTo(_s(312, s), _s(68, s), _s(316, s), _s(76, s))
          ..lineTo(_s(316, s), _s(88, s))
          ..quadraticBezierTo(_s(312, s), _s(91, s), _s(308, s), _s(83, s))
          ..close(),
        crackLight,
      );
      canvas.drawPath(
        Path()
          ..moveTo(_s(306, s), _s(45, s))
          ..quadraticBezierTo(_s(314, s), _s(42, s), _s(318, s), _s(48, s))
          ..lineTo(_s(318, s), _s(55, s))
          ..lineTo(_s(306, s), _s(50, s))
          ..close(),
        crackDark,
      );
    }
  ...
  void _drawBodyText(Canvas canvas, double s) {
    final textColor = const Color(0xFF1A1C1A).withValues(alpha: 0.5);

    _drawText(canvas, 'STIM', _s(250, s), _s(215, s), _s(28, s), textColor, s);
    _drawText(canvas, 'STORE', _s(250, s), _s(380, s), _s(24, s), textColor, s);
    _drawText(
      canvas,
      '1',
      _s(250, s),
    ...
    canvas.drawCircle(
      ...
      _s(22, s),
      Paint()..color = const Color(0xFF4A524E).withValues(alpha: 0.5),
    );

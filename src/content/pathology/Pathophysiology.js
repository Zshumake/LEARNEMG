...
export const Pathophysiology = {
    generateContent(module) {
        ...
        <div onclick="window.playModulePodcast('neuropathy-pathophysiology', 'neuropathy-poly')"

export const IntroductionData = {
    ...
    philosophy: {
        ...
        encounter: [
            ...
            { step: 4, title: "The Willy Sutton Rule", detail: "When asked why he robbed banks, the famous thief Willy Sutton famously replied, 'Because that's where the money is.' In the EDX lab, we go where the symptoms are first! If the patient is elderly, tired, or in pain, you must ensure you've captured the most suspicious muscles and nerves right at the start. Don't waste valuable time on a 'normal' foot protocol if the patient's primary complaint is a weak hand. Capture the diagnostic data early while the patient is most cooperative; you can always do the 'filler' tests later." }
        ],
        cardinalRules: [

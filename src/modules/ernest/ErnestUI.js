...
export class ErnestUI {
    ...
    _buildErnestSVG() {
        ...
        if (pId === 'earl') {
            return `
            <svg id="earl-character" class="jrpg-ernest-full-svg earl-container awake" viewBox="0 0 500 550" preserveAspectRatio="xMidYMax meet" xmlns="http://www.w3.org/2000/svg">
                <defs>

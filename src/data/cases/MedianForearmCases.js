export const medianForearmCases = {
    pronator: {
        ...
        ncsStudies: {
            sensory: [
                { name: "Median Sensory (Index)", peak: 3.8, onset: 3.2, amp: 12.0, velocity: 44, dist: 14, abnormal: true },
                { name: "Ulnar Sensory (Little)", peak: 2.8, onset: 2.2, amp: 35, velocity: 64, dist: 14, abnormal: false },
                { name: "Palmar Cutaneous (Median)", peak: "Absent", onset: "NR", amp: 0, velocity: 0, dist: 8, abnormal: true }
            ],
            motor: [
                { name: "Median Motor (APB)", latency: 4.2, amp: 8.5, velocity: 0, dist: 8, abnormal: true },
    ...
    ain: {
        ...
        ncsStudies: {
            ...
            motor: [
                { name: "Median Motor (APB)", latency: 3.8, amp: 12.0, velocity: 0, dist: 8, abnormal: false, comment: "Normal because APB is not AIN-innervated" },
                { name: "Ulnar Motor (ADM)", latency: 2.8, amp: 14.0, velocity: 0, dist: 8, abnormal: false },
                { name: "Radial Motor (EIP)", latency: 3.8, amp: 8.0, velocity: 0, dist: 10, abnormal: false, comment: "Distractor - Normal" }
            ],
            comparison: [
    ...
    struthers: {
        ...
        ncsStudies: {
            ...
            motor: [
                { name: "Median Motor (APB) - Wrist", latency: 4.0, amp: 2.5, velocity: 0, dist: 8, abnormal: true, comment: "Reduced amplitude consistent with axonal loss and thenar atrophy" },
                { name: "Median Motor (APB) - Elbow", latency: 8.5, amp: 2.3, velocity: 53, dist: 24, abnormal: false, comment: "Normal forearm conduction velocity (53 m/s)" },
                { name: "Median Motor (APB) - Axilla", latency: 13.5, amp: 2.1, velocity: 28, dist: 14, abnormal: true, comment: "Focal slowing across ligament of Struthers (28 m/s)" }
            ],
            comparison: []
        },
        emgStudies: [

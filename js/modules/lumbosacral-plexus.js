            ...
            <div class="quiz-container" style="margin-top: 30px; background: white; border-radius: 20px; padding: 30px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                ...
                <div class="quiz-question" style="max-width: 800px; margin: 0 auto;">
                    <p style="font-size: 1.2em; color: #334155; margin-bottom: 20px; font-weight: 500;">
                        A patient with diabetes presents with severe thigh pain followed by weakness in the quadriceps. EMG shows denervation in the quadriceps and adductors, but paraspinals are spared. What is the diagnosis?
                    </p>
                    <div class="options" style="display: grid; gap: 15px;">
                        <button onclick="this.style.background='#ef4444'; this.style.color='white'; this.innerText='❌ L3 Radiculopathy'" style="padding: 15px; border: 2px solid #e2e8f0; border-radius: 10px; background: white; cursor: pointer; text-align: left; font-size: 1.1em; transition: all 0.2s;">
                            L3 Radiculopathy
                        </button>

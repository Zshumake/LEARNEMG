...
const plexusData = {
    ...
    nerves: [
        ...
        {
            id: 'common_fibular',
            x: 580, y: 350, // Moved left to make room for Sural
        ...
        {
            id: 'tibial',
            x: 580, y: 450, // Moved left to make room for Sural
            label: 'Tibial',
        ...
        {
            id: 'sural',
            x: 740, y: 400, // Moved to distal end, connected to Tibial/Fibular
            label: 'Sural',
...
export function generateContent(module) {
    ...
    const LumbosacralPlexus = {
        ...
        drawPlexus: function () {
            ...
            // To Common Fibular (Moved to x=580)
            const cfPath = document.createElementNS('http://www.w3.org/2000/svg', 'path');
            cfPath.setAttribute('d', `M ${sciaticX} ${sciaticY} C ${sciaticX + 50} ${sciaticY}, ${580 - 50} ${350 + 15}, ${580} ${350 + 15}`);
            ...
            // To Tibial (Moved to x=580)
            const tibPath = document.createElementNS('http://www.w3.org/2000/svg', 'path');
            tibPath.setAttribute('d', `M ${sciaticX} ${sciaticY} C ${sciaticX + 50} ${sciaticY}, ${580 - 50} ${450 + 15}, ${580} ${450 + 15}`);
            ...
            // Sural Connections (From Tibial & Fibular -> Sural)
            // Sural is now at x=740, y=400
            const fibRightX = 580 + 140;
            const fibRightY = 350 + 15;
            const tibRightX = 580 + 140;
            const tibRightY = 450 + 15;
            const suralLeftX = 740;
            const suralY = 400 + 15;

            // Fibular -> Sural
            const fibSuralPath = document.createElementNS('http://www.w3.org/2000/svg', 'path');
            fibSuralPath.setAttribute('d', `M ${fibRightX} ${fibRightY} C ${fibRightX + 20} ${fibRightY}, ${suralLeftX - 20} ${suralY}, ${suralLeftX} ${suralY}`);
            fibSuralPath.setAttribute('stroke', '#94a3b8');
            fibSuralPath.setAttribute('stroke-width', '2');
            fibSuralPath.setAttribute('fill', 'none');
            fibSuralPath.classList.add('plexus-connection');
            fibSuralPath.setAttribute('data-nerve', 'sural'); // Triggers when Sural is selected
            fibSuralPath.setAttribute('data-segment', 'nerve-sural');
            svg.insertBefore(fibSuralPath, svg.firstChild);

            // Tibial -> Sural
            const tibSuralPath = document.createElementNS('http://www.w3.org/2000/svg', 'path');
            tibSuralPath.setAttribute('d', `M ${tibRightX} ${tibRightY} C ${tibRightX + 20} ${tibRightY}, ${suralLeftX - 20} ${suralY}, ${suralLeftX} ${suralY}`);
            tibSuralPath.setAttribute('stroke', '#94a3b8');
            tibSuralPath.setAttribute('stroke-width', '2');
            tibSuralPath.setAttribute('fill', 'none');
            tibSuralPath.classList.add('plexus-connection');
            tibSuralPath.setAttribute('data-nerve', 'sural');
            tibSuralPath.setAttribute('data-segment', 'nerve-sural');
            svg.insertBefore(tibSuralPath, svg.firstChild);
    ...
    return `
        <div class="lumbosacral-plexus-container" style="max-width: 1200px; margin: 0 auto; padding: 20px;">
            ...
            <!-- Quiz Section -->
            <div class="quiz-container" style="margin-top: 30px; background: white; border-radius: 20px; padding: 30px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                <h3 style="color: #1e40af; margin-bottom: 20px; font-size: 1.5em; text-align: center;">🧠 Quick Knowledge Check</h3>
                <div class="quiz-question" style="max-width: 800px; margin: 0 auto;">
                    <p style="font-size: 1.2em; color: #334155; margin-bottom: 20px; font-weight: 500;">
                        A patient with diabetes presents with severe, progressive thigh pain followed by wasting and weakness in the quadriceps. EMG shows denervation in the quadriceps and adductors, but paraspinals are spared. What is the most likely diagnosis?
                    </p>
                    <div class="options" style="display: grid; gap: 15px;">
                        <button onclick="this.style.background='#ef4444'; this.style.color='white'; this.innerText='❌ L5 Radiculopathy'" style="padding: 15px; border: 2px solid #e2e8f0; border-radius: 10px; background: white; cursor: pointer; text-align: left; font-size: 1.1em; transition: all 0.2s;">
                            L5 Radiculopathy
                        </button>
                        <button onclick="this.style.background='#22c55e'; this.style.color='white'; this.innerText='✅ Diabetic Amyotrophy'" style="padding: 15px; border: 2px solid #e2e8f0; border-radius: 10px; background: white; cursor: pointer; text-align: left; font-size: 1.1em; transition: all 0.2s;">
                            Diabetic Amyotrophy
                        </button>
                        <button onclick="this.style.background='#ef4444'; this.style.color='white'; this.innerText='❌ Femoral Neuropathy'" style="padding: 15px; border: 2px solid #e2e8f0; border-radius: 10px; background: white; cursor: pointer; text-align: left; font-size: 1.1em; transition: all 0.2s;">
                            Femoral Neuropathy
                        </button>
                    </div>
                </div>

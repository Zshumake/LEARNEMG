...
export function generateContent(module) {
    ...
    return `
                                    ...
                                    <div style="background: #eff6ff; padding: 20px; border-radius: 12px; border-left: 5px solid #3b82f6; margin-bottom: 20px;">
                                        ...
                                        <p style="color: #475569; margin-bottom: 0;">
                                            ...
                                            <ul style="margin-top: 10px; margin-bottom: 0; padding-left: 20px;">
                                                <li><strong>Serratus Anterior (Long Thoracic N.):</strong> Winging scapula? Check C5-C7 roots.</li>
                                                <li><strong>Rhomboids (Dorsal Scapular N.):</strong> Weak shoulder retraction? Check C5 root.</li>
                                            </ul>
                                        </p>
                                    </div>
                                </div>
        ...
        {
            question: "Which nerve injury results in 'winging of the scapula'?",
            options: [
            ...
            correct: 2,
            explanation: "Winging of the scapula is caused by weakness of the SERRATUS ANTERIOR muscle, which is innervated by the LONG THORACIC NERVE (C5, C6, C7). This nerve branches off the roots *before* the plexus trunks."
        },
        {
        ...
        {
            question: "In a patient with a suspected brachial plexus injury, what does a NORMAL SNAP amplitude in a numb area suggest?",
            options: [
                "Plexopathy",
